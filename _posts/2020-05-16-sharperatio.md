---
title: "Risk and Returns: The Sharpe Ratio":bar_chart:
date: 2020-05-16
...
## Visualizing daily prices:chart_with_upwards_trend:
...
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/sp_500_graph.jpg" alt="S&P 500 data">

## Inputs for Sharpe Ratio:incoming_envelope:
...
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/stock_returns.jpg" alt="Percentage change in stocks">
In the same way, we need to find daily S&P 500 returns.
```python
    sp_returns = benchmark_data['S&P 500'].pct_change()
```
This is what you get after plotting the returns -
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/sp_500_returns.jpg" alt="Percentage change in S&P 500">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/excess_returns.jpg" alt="Excess Returns">

## Calculating the Sharpe Ratio:pencil:
...
```
After plotting -
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/mean_returns.jpg" alt="Mean Returns">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/sd_returns.jpg" alt="Standard Deviation of Returns">
...
<img src="{{ site.url }}{{ site.baseurl }}/images/sharpe_ratio_blog/result.jpg" alt="Result">

## Conclusion:money_with_wings:
...
## Sharpe Ratio Calculator:computer:
